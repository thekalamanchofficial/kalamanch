...
type UsePostUnpublishing = (
  props: PostUnpublishingProps,
) => UsePostUnpublishingReturn;

export const usePostUnpublishing: UsePostUnpublishing = ({
