...
export default function Page() {
  ...
  const next = () => {
    if (formNo === 1 && state.name && state.email && state.birthdate) {
      setFormNo(formNo + 1);
            ...
            <div className="w-full px-10">
              <div className="mb-3 flex flex-col gap-2">
                ...
                <h1 className="mb-4 text-lg font-medium text-font-secondary">
                  We hope that you will have wonderful time at kalamanch.
                </h1>
                {information.map((info) => (
                  <div className="mb-2 flex h-20 w-full gap-6">
                    <div className="flex w-1/12 items-center justify-start">
                      <span className="block h-14 w-14 rounded-full bg-brand-secondary"></span>
                    </div>
                    <div className="flex w-11/12 flex-col items-start justify-start">
                      <h1 className="font-semiboldk text-lg text-font-primary">
                        {info.title}
                      </h1>
