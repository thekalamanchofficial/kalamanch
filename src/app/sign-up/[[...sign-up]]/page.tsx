...
export default function Page() {
  ...
  const next = () => {
    if (formNo === 1 && state.name && state.birthdate) {
      setFormNo(formNo + 1);
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center bg-brand-secondary">
      ...
      <div className="flex aspect-square h-auto max-h-[672px] w-full max-w-3xl flex-col items-center gap-y-16 rounded-lg bg-white px-6 py-6 md:aspect-auto">
          ...
          {formNo === 1 && (
            <div className="w-full px-10">
              <div className="mb-3 flex flex-col">
                <label
                  htmlFor="name"
                  className="text-font-gray mb-2 block text-base font-bold"
                >
                  Your name
                </label>
                <div className="relative flex">
                  <input
                    ...
                    id="name"
                    className="placeholder:text-font-tertiary mb-5 block w-full min-w-0 flex-1 rounded-md border border-gray-200 p-3 text-base font-light text-gray-900"
                ...
                <div className="relative flex flex-col items-start justify-center">
                  ...
                  {/* add a div that seems like a horizontal  line to add a break */}
                  <button className="mb-4 ml-3 border-b border-b-brand-primary text-brand-primary">
